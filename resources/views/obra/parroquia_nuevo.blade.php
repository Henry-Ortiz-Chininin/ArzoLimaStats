...
<div class="container">
    <div class="row">
        <div class="col-10">
        <h3>Parroquia - {{ $Parroquia->x_nombre }} - Obras - Nuevo</h3>
        </div>
                ...
                <div class="card-body" >
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            ...
                            @foreach ($ObraSocial as $obra)
                                <option value="{{ $obra->c_codigo }}" />{{ $obra->x_nombre }}</option>
                            @endforeach
                            </select>
                    ...
                    <div class="form-group row">
                        ...
                        <input id="TipoObra" type="text"
                            ...
                            name="TipoObra"
                            value="{{ old('TipoObra') }}" required autocomplete="off" autofocus
                    ...
                    <div class="form-group row">
                        ...
                        <input id="Atendido" type="text"
                            ...
                            name="Atendido"
                            value="{{ old('Atendido') }}" autocomplete="off" autofocus
