                ...
                <div class="card-body" >
                    ...
                    <div class="form-group row">
                        ...
                        <input id="Tipo" type="text"
                            ...
                            name="Tipo"
                            value="{{ old('Tipo') }}" required autocomplete="off" autofocus
                            placeholder="Tipo">
                    ...
                    <div class="form-group row">
                        ...
                        <input id="Director" type="text"
                            ...
                            name="Director"
                            value="{{ old('Director') }}" required autocomplete="off" autofocus
                        ...
                        <div class="col-2">
                            <div class="form-group row">
                                ...
                                <input id="Guarderia" type="text" class="form-control" name="Guarderia"
                                    value="{{ old('Guarderia') }}" autocomplete="off" autofocus>
                            </div>
                        </div>
                        <div class="col-2">
                            <div class="form-group row">
                                ...
                                <input id="Inicial" type="text" class="form-control" name="Inicial"
                                    value="{{ old('Inicial') }}" autocomplete="off" autofocus>
                            </div>
                        </div>
                        <div class="col-2">
                            <div class="form-group row">
                                ...
                                <input id="Jardin" type="text" class="form-control" name="Jardin"
                                    value="{{ old('Jardin') }}" autocomplete="off" autofocus>
                            </div>
                        </div>
                        <div class="col-2">
                            <div class="form-group row">
                                ...
                                <input id="Primaria" type="text" class="form-control" name="Primaria"
                                    value="{{ old('Primaria') }}" autocomplete="off" autofocus>
                            </div>
                        </div>
                        <div class="col-2">
                            <div class="form-group row">
                                ...
                                <input id="Secundaria" type="text" class="form-control" name="Secundaria"
                                    value="{{ old('Secundaria') }}" autocomplete="off" autofocus>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-2">
                            <div class="form-group row">
                                ...
                                <input id="Tecnico" type="text" class="form-control" name="Tecnico"
                                    value="{{ old('Tecnico') }}" autocomplete="off" autofocus>
                            </div>
                        </div>
                        <div class="col-2">
                            <div class="form-group row">
                                ...
                                <input id="Ocupacional" type="text" class="form-control" name="Ocupacional"
                                    value="{{ old('Ocupacional') }}" autocomplete="off" autofocus>
                            </div>
                        </div>
                        <div class="col-2">
                            <div class="form-group row">
                                ...
                                <input id="Especial" type="text" class="form-control" name="Especial"
                                    value="{{ old('Especial') }}" autocomplete="off" autofocus>
                            </div>
                        </div>
                    </div>
                    <hr />
