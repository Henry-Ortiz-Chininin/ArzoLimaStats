...
<div class="container">
    <div class="row">
        <div class="col-10">
        <h3>Parroquia - {{ $Parroquia->x_nombre }} - Sacramento - Nuevo</h3>
        </div>
                    ...
                    <div class="row">
                        <div class="col-3">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                <input id="bauinf" type="text" class="form-control" name="bauinf"
                                    value="{{ old('bauinf') }}" autocomplete="off" autofocus></div>
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                <input id="baunin" type="text" class="form-control" name="baunin"
                                    value="{{ old('baunin') }}" autocomplete="off" autofocus></div>
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                <input id="baumay" type="text" class="form-control" name="baumay"
                                    value="{{ old('baumay') }}" autocomplete="off" autofocus></div>
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                <input id="bauadu" type="text" class="form-control" name="bauadu"
                                    value="{{ old('bauadu') }}" autocomplete="off" autofocus></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-3">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="pcteca" type="text" class="form-control" name="pcteca"
                                    value="{{ old('pcteca') }}" autocomplete="off" autofocus></div>
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="pccole" type="text" class="form-control" name="pccole"
                                    value="{{ old('pccole') }}" autocomplete="off" autofocus></div>
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="coteca" type="text" class="form-control" name="coteca"
                                    value="{{ old('coteca') }}" autocomplete="off" autofocus></div>
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="cocole" type="text" class="form-control" name="cocole"
                                    value="{{ old('cocole') }}" autocomplete="off" autofocus></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-3">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="matcat" type="text" class="form-control" name="matcat"
                                    value="{{ old('matcat') }}" autocomplete="off" autofocus></div>
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="matmix" type="text" class="form-control" name="matmix"
                                    value="{{ old('matmix') }}" autocomplete="off" autofocus></div>
                            </div>
                        </div>
                    </div>
