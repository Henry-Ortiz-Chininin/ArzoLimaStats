...
<div class="container">
    <div class="row">
        <div class="col-10">
        <h3>Congregacion - {{ $Congregacion->x_nombre }} - Religioso - Nuevo</h3>
        </div>
                        ...
                        <div class="col-3">
                            <div class="form-group row">
                                ...
                                <input id="n_profesos" type="text" class="form-control" name="n_profesos"
                                    value="{{ old('n_profesos') }}" autocomplete="off" autofocus></div>
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="form-group row">
                                ...
                                <input id="n_profesas" type="text" class="form-control" name="n_profesas"
                                    value="{{ old('n_profesas') }}" autocomplete="off" autofocus></div>
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="form-group row">
                                ...
                                <input id="n_sacerdotes" type="text" class="form-control" name="n_sacerdotes"
                                    value="{{ old('n_sacerdotes') }}" autocomplete="off" autofocus></div>
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="form-group row">
                                ...
                                <input id="n_laicosconsagrados" type="text" class="form-control" name="n_laicosconsagrados"
                                    value="{{ old('n_laicosconsagrados') }}" autocomplete="off" autofocus></div>
                            </div>
                        </div>
                    </div>
