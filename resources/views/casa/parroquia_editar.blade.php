                ...
                <div class="card-body" >
                    ...
                    <div class="form-group row">
                        ...
                        <input id="Nombre" type="text"
                            ...
                            name="Nombre"
                            value="{{ old('Nombre')?old('Nombre'):$Casa->nombre }}" required autocomplete="off" autofocus
                            placeholder="Nombre">
                    ...
                    <div class="form-group row">
                        ...
                        <input id="Direccion" type="text"
                            ...
                            name="Direccion"
                            value="{{ old('Direccion')?old('Direccion'):$Casa->direcc }}" required autocomplete="off" autofocus
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            ...
                            @foreach ($Distritos as $d)
                                <option value="{{ $d->c_codigo }}" {{ $d->c_codigo==$Casa->distri?'selected':'' }} >{{ $d->x_nombre }}</option>
                            @endforeach
                            </select>
                    ...
                    <div class="form-group row">
                        ...
                        <input id="Telefono" type="text"
                            ...
                            name="Telefono"
                            value="{{ old('Telefono')?old('Telefono'):$Casa->telef1 }}" required autocomplete="off" autofocus
                    ...
                    <div class="form-group row">
                        ...
                        <input id="Fax" type="text"
                            ...
                            name="Fax"
                            value="{{ old('Fax')?old('Fax'):$Casa->telfax }}" autocomplete="off" autofocus
                    ...
                    <div class="form-group row">
                        ...
                        <input id="Apartado" type="text"
                            ...
                            name="Apartado"
                            value="{{ old('Apartado')?old('Apartado'):$Casa->aparta }}" autocomplete="off" autofocus
                    ...
                    <div class="form-group row">
                        ...
                        <input id="Responsable" type="text"
                            ...
                            name="Responsable"
                            value="{{ old('Responsable')?old('Responsable'):$Casa->respon }}" autocomplete="off" autofocus
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            ...
                            @foreach ($Congregaciones as $cong)
                                <option value="{{ $cong->c_codigo }}" {{$cong->c_codigo==$Casa->c_congre?'selected':'' }}>{{ $cong->x_nombre }}</option>
                            @endforeach
                            </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input id="FechaConsitucion" type="date"
                                    ...
                                    value="{{ old('FechaConsitucion')?old('FechaConsitucion'):date('Y-m-d', strtotime($Casa->d_constitucion)) }}" required autocomplete="off" autofocus>
                    ...
                    <div class="form-group row">
                        ...
                        <input id="Observacion" type="text"
                            ...
                            name="Observacion"
                            value="{{ old('Observacion')?old('Observacion'):$Casa->observ }}" autocomplete="off" autofocus
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input id="FechaEreccion" type="date"
                                    class="form-control @error('FechaEreccion') is-invalid @enderror"
                                    name="FechaEreccion"
                                    value="{{ old('FechaEreccion')?old('FechaEreccion'):date('Y-m-d', strtotime($Casa->d_erecion)) }}" required autocomplete="off" autofocus>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <select id="Desactivado" name="Desactivado" class="form-select" aria-label="Desactivado">
                                <option value="1" {{ $Casa->i_desactivada==1?'Selected':'' }}>Si</option>
                                <option value="0" {{ $Casa->i_desactivada==0?'Selected':'' }}>No</option>
                            </select>
                        </div>
                    </div>  
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input id="FechaDesactivacion" type="date"
                                    ...
                                    value="{{ old('FechaDesactivacion')?old('FechaDesactivacion'):date('Y-m-d', strtotime($Casa->d_desactivada)) }}" required autocomplete="off" autofocus>
