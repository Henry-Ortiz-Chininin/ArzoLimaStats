...
<div class="container">
    <div class="row">
        <div class="col-10">
        <h3>Parroquia - {{ $Parroquia->x_nombre }} - Catequistas - Editar</h3>
        </div>
                        ...
                        <div class="col-3">
                            ...
                            <div class="form-group row">
                                ...
                                <input id="Agno" type="number"  min="1950" max="2100"
                                    ...
                                    name="Agno"
                                    value="{{ old('Agno')?old('Agno'):$Catequista->c_anno }}" required autocomplete="off" autofocus
                                    placeholder="Agno">
                        ...
                        <div class="col-3">
                            <div class="form-group row">
                                ...
                                <input id="n_cateq" type="text" class="form-control" name="n_cateq"
                                    value="{{ old('n_cateq')?old('n_cateq'):$Catequista->n_cateq }}" autocomplete="off" autofocus></div>
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="form-group row">
                                ...
                                <input id="n_agenp" type="text" class="form-control" name="n_agenp"
                                    value="{{ old('n_agenp')?old('n_agenp'):$Catequista->n_agenp }}" autocomplete="off" autofocus></div>
                            </div>
                        </div>
                    </div>
